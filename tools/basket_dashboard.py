...
try:
    ...
    FX_DEFAULTS = {'EURUSD': 1.16, 'GBPEUR': 1.15, 'DKKEUR': 0.134}
...
def get_fx_rates():
    defaults = {'EURUSD': FX_DEFAULTS.get('EURUSD', 1.16), 'GBPEUR': FX_DEFAULTS.get('GBPEUR', 1.15), 'DKKEUR': FX_DEFAULTS.get('DKKEUR', 0.134)}
    fallbacks, rates = [], {}
