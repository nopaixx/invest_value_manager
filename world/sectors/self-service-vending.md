...
> Laundry: +10% revenue, 1,145 net installs (record +27.2%). Photo.ME: -4% (Germany regulation headwind confirmed).
> Audit clean (Forvis Mazars). Buyback £15-20M launched. Shares resumed trading.
> R4 BUY APPROVED S284: SO 135p, EUR 300, QS 80 Tier A. Price 136.6p (1.2% above trigger).
> DA MODERATE COUNTER: Germany regulation is HEADWIND not tailwind, laundry "near-monopoly" overstated (Speed Queen 1,500+ EU stores).
> KC added: FY2026 audit delay recurrence → mandatory re-evaluation.

## Resumen Ejecutivo

El sector de self-service vending y unattended retail abarca desde photobooths de identificacion y entretenimiento, hasta kioscos de lavanderia autoservicio, maquinas expendedoras inteligentes y micro-tiendas automatizadas. El TAM combinado en Europa supera los EUR 30B (vending general EUR 24B + laundry autoservicio EUR 5B + photobooths EUR 0.7B), con crecimientos diferenciados por subsegmento: la lavanderia autoservicio crece al 9-10% CAGR, los photobooths al 8-10%, y el vending general al 4-5%.

El sector es fundamentalmente FRAGMENTADO, con cientos de operadores locales en vending general, pero presenta NICHOS DE MONOPOLIO NATURAL en subsegmentos especializados. El caso mas notable es ME Group International (MEGP.L), que domina el subsegmento de photobooths (30-60% de cuota segun geografia) y kioscos de lavanderia (monopolio efectivo en su formato). La economia unitaria de estos nichos crea barreras: alto coste de red instalada (>30.000 photobooths, >7.800 kioscos de lavanderia), contratos exclusivos con ubicaciones de alto trafico, y la necesidad de certificacion regulatoria para ID photos.

Las dinamicas regulatorias son el factor diferenciador clave. La transicion de Alemania a fotos digitales obligatorias para documentos de identidad (desde mayo 2025) ha creado un headwind temporal para photobooths no adaptados, pero un tailwind estructural para operadores con tecnologia de transmision digital certificada. Esta regulacion se espera se propague por la UE. Al mismo tiempo, la lavanderia autoservicio crece impulsada por urbanizacion, hogares unipersonales y la penetracion aun baja en muchos mercados europeos. El sentimiento del mercado hacia este sector es de DESINTERES (ignorado), lo que crea oportunidades para el inversor paciente que entienda la economia unitaria.

---

## Metricas Clave

| Metrica | Valor | Fuente | Tendencia |
|---------|-------|--------|-----------|
| TAM Vending Europa | ~EUR 24B (2024) | Grand View Research [Nivel 2] | CAGR 4.8% |
| TAM Laundry Autoservicio Europa | EUR 5.2B (2024) | Grand View Research [Nivel 2] | CAGR 9.7% |
| TAM Photobooth Global | USD 0.7-5.0B (2025) | Varias fuentes [Nivel 2, alta dispersion] | CAGR 8-12% |
...
**Concentracion:** Fragmentado en vending general. Oligopolio/Monopolio en nichos especializados (photobooths ID, laundry kiosk).

### Subsegmento Photobooths ID
| Empresa | Posicion | Geo | Listada |
|---------|----------|-----|---------|
| ME Group (MEGP.L) | Lider global, 31,000+ booths, 30-60% share | 18+ paises | LSE (FTSE 250) |
| Max Spielmann | ~pocos cientos de booths UK | UK | Privada (Timpson Group) |
| DNP Dai Nippon Printing | Fabricante, no operador | Japon | TYO: 7912 |
| Operadores locales fragmentados | <5% cada uno | Varios | N/A |

### Subsegmento Laundry Kiosk/Autoservicio
| Empresa | Posicion | Geo | Listada |
|---------|----------|-----|---------|
...
### Subsegmento Vending General (Alimentos/Bebidas)
| Empresa | Posicion | Geo | Listada |
|---------|----------|-----|---------|
| Selecta Group | ~EUR 1.6B revenue | Europa | Privada (KKR) |
| Azkoyen (AZK.MC) | Fabricante + pagos | Espana/EU | BME |
| Crane NXT (CXT) | Payment tech + automation | US/Global | NYSE |
| Fuji Electric | Fabricante de maquinas | Japon | TYO: 6504 |
| Cantaloupe (CTLP) | Cashless payments vending | US | NASDAQ |

**Barreras de entrada:** Medias-Altas en nichos especializados
- Red de ubicaciones con contratos exclusivos (5-7 anos, alta renovacion)
- Certificacion regulatoria para ID photos (biometrica, transmision segura)
- Escala de fabricacion (coste unitario declina con volumen)
- Know-how tecnico + mantenimiento de flota
- Capital inicial significativo para desplegue de red

**Barreras en vending general:** Bajas-Medias
- Maquinas comoditizadas
- Ubicaciones mas faciles de conseguir
- Multiples fabricantes competidores
...
|--------|--------------|-------|
| Tipos de interes | Baja | Revenue recurente, bajo apalancamiento |
| Recesion | Baja-Media | Photobooths ID: inelastico. Laundry: esencial. Entertainment photo: ciclico |
...
### Ventajas del lider (ME Group)
1. **Escala de red inigualable:** 31,000+ photobooths y 7,892 kioscos laundry. Ningun competidor se acerca. La escala permite amortizar R&D, fabricacion in-house, y negociacion de ubicaciones premium.
...
- Menor inversion por unidad (GBP 28,000 vs >GBP 100,000 para laundromat)
- Ubicado en supermercados, gasolineras, areas residenciales
- Sin personal, sin alquiler de local separado
...
1. **Regulacion Alemania (corto plazo):** La exigencia de que fotos ID se tomen en oficinas gubernamentales o fotografos certificados IMPACTO directo en revenue de photobooths en Alemania en H2 FY2025 (Photo.ME revenue -4% YoY). Si ME Group no obtiene certificacion rapida para sus booths en Alemania, este mercado podria perderse temporalmente.
...
**Sentimiento actual:** IGNORADO

El sector de "photobooths y kioscos de lavanderia" no tiene ETF dedicado, ni cobertura sell-side significativa, ni narrativa de mercado. Es un sector invisible para la mayoria de inversores institucionales. MEGP.L tiene market cap de ~GBP 500M (FTSE 250) pero con cobertura de analistas muy limitada.

**Narrativa dominante:**
"Sector legacy, photobooths son tecnologia del pasado, disrupcion digital los va a matar."

**Mi contra-tesis:**
"Las photobooths no son un negocio de fotos, son un negocio de UBICACIONES con contratos exclusivos + certificacion regulatoria. La regulacion biometrica INCREMENTA la barrera de entrada, no la reduce. La lavanderia kiosk es un segundo motor de crecimiento con runway de >10 anos y monopolio de formato. El mercado descuenta el headwind aleman sin entender el tailwind regulatorio estructural."

**Flujos de fondos (12m):** N/A — sector demasiado nicho para tracking de flujos
**Cobertura de analistas:** Muy baja (2-3 brokers cubren MEGP.L)

---

## Nuestras Posiciones Actuales

(Ninguna actualmente en portfolio)
...
|------|--------|-------------|-------------|--------|
| Pipeline | MEGP.L | thesis/research/MEGP.L | 2026-02-18 | R4 approved conditional |
...
### Comparables tangenciales (listados, diferente subsegmento)
| Ticker | Empresa | Relevancia |
|--------|---------|------------|
| CXT (NYSE) | Crane NXT | Payment tech para vending, P/E ~20x. Fabricante, no operador. |
| CTLP (NASDAQ) | Cantaloupe | Cashless vending payments US. Diferente modelo. |
| 6504.T (TYO) | Fuji Electric | Fabricante de vending machines Japon. |

### Evitar
| Ticker | Razon |
|--------|-------|
| (ninguno identificado) | Sector demasiado nicho para haber identificado trampas de valor |
...
|--------|---------|----|----- -|---------|--------|----------------|
| MEGP.L | ME Group International | (pendiente thesis) | (R4 conditional) | (razonar) | R4 approved | 2026-02-18 |
...
**Fuente:** ME Group RNS announcements, annual reports [Nivel 1 — datos primarios de la empresa]
...
- Mover "Historial de Analisis" a archivo separado: world/sectors/archive/self-service-vending-history.md
