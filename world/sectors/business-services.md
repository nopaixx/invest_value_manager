...
**Tesis principal ACTUALIZADA (2026-03-17)**: El sector esta TRIFURCADO:

1. **Information Services / Data Analytics** (WIDE moat, high ROIC, recurring) -- Verisk, RELX, Wolters Kluwer, Gartner, FactSet, S&P Global, Moody's. Quality compounders del sector. Capital-light, datos propietarios, switching costs. La mayoria sigue 30-65% por debajo de 52w highs. El SaaSpocalypse selloff se ha MODERADO pero no revertido — los mejores nombres (VRSK, WKL.AS) muestran resiliencia AI (WKL.AS nombrada 3x Leader en Gartner Magic Quadrant Financial Close Mar 2026). IT y FDS en nuevos minimos ($160, $207). OPORTUNIDAD SELECTIVA: el mercado sigue castigando indiscriminadamente pero los datos propietarios son INSUMOS para AI, no victimas.

2. **Testing/Inspection/Certification (TIC)** (medium moat, steady growth) -- Bureau Veritas, SGS, Intertek, Eurofins. Regulacion crea demanda estructural. BVI.PA (QS 69) corrigio desde EUR 29 a EUR 27.68, ahora -9% off 52wH. ITRK.L en 52wL (3650p), interesante por primera vez. EU AI Act (Aug 2026) y ESG reporting mandates crean demanda incremental estimada en $180B+ compliance services.
...
| **Employee Benefits** | $246-280B (>$1T incl. engagement) | 4-5% | Edenred, Pluxee, WEX |
| **Gift Cards/B2B Incentives (Europe)** | $85.8B (2026, +7.8% YoY) | 7-8% | Edenred, Pluxee, WEX, regional players |
| **Tax Services** | $15-20B | 2-3% | Intuit (60%), H&R Block |
| **Government Consulting** | $100B+ | 5-8% | BAH, CACI, LDOS, SAIC |

---

## Screening Results (UPDATED 2026-03-17 — prices refreshed)
...
| **BVI.PA** | Bureau Veritas | TIC | -- | -- | +11.8pp | -- | -- | -- | -- | **69** | B | EUR 27.7 | EUR 30.4 | -9% |
| **ITRK.L** | Intertek Group | TIC | 18.0% | 7.0% | +11.0pp | 13.6% | 56.9% | +6.8% | 1.5x | **63** | B | 3650p | 5150p | **-29%** |
| **EXLS** | ExlService | Analytics/BPO | 18.1% | 8.8% | +9.3pp | 12.1% | 37.6% | +17.9% | 0.1x | **61** | B | $30 | $49 | **-39%** |
| **BR** | Broadridge | FinComm/Tech | 15.5% | 8.9% | +6.6pp | 15.3% | 31.0% | +6.5% | 1.7x | **61** | B | $179 | $272 | -34% |
| **EXPN.L** | Experian | Credit Data | 13.7% | 8.0% | +5.7pp | 18.0% | 55.1% | +6.2% | 2.2x | **60** | B | 2752p | 4101p | -33% |

### Companies Priced but NOT Scored (lower priority, UPDATED 2026-03-17)

| Ticker | Name | Subsector | Price | P/E | Yield | MCap(B) | %offHi | Notes |
|--------|------|-----------|-------|-----|-------|---------|--------|-------|
| REL.L | RELX PLC | Info Services | 2581p | 23.0 | 2.6% | EUR 46B | -38% | Data/analytics giant, WIDE moat |
| CPRT | Copart | Vehicle Auctions | $34 | 21.3 | 0.0% | EUR 33B | -47% | Network effects, capital-light. NEW LOW. |
| SPGI | S&P Global | Ratings/Data | $427 | 29.1 | 0.0% | EUR 129B | -26% | Monopoly, recovering |
| MCO | Moody's Corp | Ratings | $433 | 31.7 | 0.0% | EUR 77B | -21% | Duopoly with SPGI |
| CTAS | Cintas | Uniform Rental | -- | ~40x | -- | -- | -- | Quality compounder, expensive |
| DPLM.L | Diploma PLC | Distribution | -- | ~40x | ~1% | -- | -- | Serial acquirer, WIDE moat |
| HLMA.L | Halma PLC | Safety/Enviro | -- | ~42x | -- | -- | -- | Quality compounder, expensive |
| PSON.L | Pearson PLC | Education | -- | ~14x | ~3% | -- | -- | Digital transition, mixed |
| TRI | Thomson Reuters | Legal/Tax Data | -- | ~26x | ~3% | -- | -- | Declining from highs |
...
- At $205, it is 37% below 52wH of $323. P/E 31.6x. Pulled back from $215 (Mar 7) to $205.
- WIDE moat: proprietary actuarial data, switching costs, regulatory mandates.
- **FV $260, Entry $150. Added to quality universe.**
- Feb 18 earnings BEAT: EPS $1.82 vs $1.60 consensus. Revenue $779M vs $774M est. FY26 guidance EPS $7.45-$7.75. $2.5B buyback authorized.
- AI is tailwind (data is input to AI models). Failed AccuLynx acquisition is net positive.
- **STATUS: Above entry ($205 vs $150). Drifted back from $215 peak. Monitor. Oil crisis may create buying opportunity if broader market sells off further.**
...
- At $55, now 17% off 52wH of $66. P/E 50.5x -- still expensive but cheaper than Mar 7.
- Near-zero AI disruption risk. Defensive, recession-resistant.
- **Priority: MEDIUM. Outstanding quality but valuation prohibitive. Oil crisis = safe haven but already priced as such.**

**3. WKL.AS (Wolters Kluwer) -- QS 77, Tier A -- IN PORTFOLIO**
...
**4. IT (Gartner) -- QS 73 tool / 71 adj (B), Tier B -- R4 WATCHLIST**
...
- At $160, it is 65% below 52wH of $461. P/E 16.6x. NEW 52W LOW territory.
- Gartner recently announced top predictions for Data & Analytics 2026, confirming relevance of advisory in AI era. But: 60% of AI projects abandoned by 2026 due to data quality (Gartner's own prediction) = demand for Gartner advisory services.
- QS DOWNGRADED to 71 adj (B) in R4. FV $190, Entry $120-130. Hard gate Q1 2026 (May).
- **STATUS: R4 WATCHLIST. Price $160 still above entry $120-130. Approaching — delta narrowing. Monitor Q1 data in May.**

### Tier B Candidates (QS 65-74)

**5. BAH (Booz Allen Hamilton) -- QS 73, Tier B -- R1 COMPLETE**
- US government consulting/technology leader. 97% revenue from US gov.
- ROIC 23.6%, +18.1pp spread. Revenue CAGR +12.7%.
- At $76, it is 42% below 52wH. P/E 11.2x. Yield 3.1%. New low since last update.
- Risk: DOGE (government spending cuts). Section 301 probes + trade war may shift DOD priorities but BAH is defense-adjacent.
- Higher leverage 2.6x and volatile FCF margin.
- **Priority: MEDIUM. Cheapening but DOGE risk is structural. Needs clarity on FY27 government budget.**
...
- At $207, it is 56% below 52wH. P/E 13.2x. Yield 2.1%. Deepening selloff from $226 (Mar 7).
- Competes with Bloomberg Terminal, MORN, SPGI, LSEG.
- **Priority: MEDIUM. Valuation increasingly attractive (P/E 13.2x for ROIC 19%) but competitive field crowded. Monitor.**

---

## Metricas Clave por Sub-sector

### Information Services (opportunity zone — SELECTIVE, prices still compressed)

| Metrica | Valor | vs Historia | Tendencia |
|---------|-------|-------------|-----------|
| TAM Global | $200-250B | +8% YoY | Up |
| P/E sector promedio | 12-32x | vs 25-40x (2021) | Recovering selectively |
| ROIC tipico | 20-50% | Above avg | Stable |
| AI impact | TAILWIND for data, THREAT for advisory | WKL.AS Gartner MQ 3x Leader confirms | |
| AI spending global | $300B+ by 2026 (IDC) | Analytics fastest-growing segment | Up |

### TIC (steady, ITRK.L newly interesting at 52wL)

| Metrica | Valor | vs Historia | Tendencia |
|---------|-------|-------------|-----------|
| TAM Europe | EUR 70B | +4% CAGR | Up |
| P/E sector | 17-21x | vs 25-35x | Normalizing |
...
- AI reinforces moat: proprietary data is INPUT to AI models, not disrupted by them
...
- EU AI Act (Aug 2026) creates NEW testing/certification demand for AI systems

### Employee Benefits
**Concentracion:** Oligopolio (Edenred ~40% France, Pluxee #2, WEX US)
**Barreras de entrada:** MEDIUM-HIGH (under pressure)
- Regulatory licenses per country, network of merchants, technology platform
...
| Factor | Info Services | TIC | BPO | Employee Benefits |
|--------|-------------- |-----|-----|-------------------|
...
2. El selloff ha comprimido multiples de empresas con ROIC 20-50% a niveles de empresas ciclicas. Esto no esta justificado para negocios con 90%+ recurring revenue.
...
- **FY 2025 Results (24-Feb-2026):**
  ...
  - Adjusted EPS EUR 2.59 (+10%)
  - FCF conversion 82% (+12pp), leverage 0.9x (-31% net debt)
...
| Sold | MORN | -- | 2026-03-07 | SOLD. Rotated to TW + WKL.AS. |

---

## Empresas Objetivo (UPDATED 2026-03-17)

### Para analisis profundo (Priority: Quality Universe candidates)

| Ticker | Empresa | QS Tool | Sub-sector | Priority | Reason |
|--------|---------|---------|------------|----------|--------|
| **IT** | Gartner | 73 (B) | Research/Advisory | **ALTA** | P/E 16.6x at 52wL, approaching entry $120-130. Q1 May = catalyst. |
| **BAH** | Booz Allen Hamilton | 73 (B) | Gov Consulting | MEDIA | P/E 11.2x, -42% off 52wH. DOGE risk structural. |
| **FDS** | FactSet Research | 73 (B) | Financial Data | MEDIA | P/E 13.2x, -56% off 52wH. Deepening selloff. |
| **ITRK.L** | Intertek Group | 63 (B) | TIC | MEDIA | At 52wL 3650p. P/E 16.9x. EU AI Act tailwind. Needs QS refresh. |
| **ROL** | Rollins | 79 (A) | Pest Control | BAJA | QS 79 but P/E 51x. Defensive. Wait for pullback. |
| **REL.L** | RELX | -- | Info Services | BAJA | Not scored. P/E 23x, -38% off 52wH. Large cap. |
| **CPRT** | Copart | -- | Vehicle Auctions | BAJA | P/E 21x, -47% off 52wH. NEW LOW. Network effects. Needs scoring. |

### Already in quality universe

| Ticker | QS | Status | Notes |
|--------|-----|--------|-------|
| **VRSK** | **85 adj (A)** | **R1_COMPLETE** | Insurance data monopoly, FV $260, entry $150. Price $205 — above entry. |
| **IT** | **71 adj (B)** | **R4_WATCHLIST** | FV $190, entry $120-130. Price $160 — approaching entry. Q1 May. |
| BVI.PA | 69 | SCORED | TIC candidate, entry EUR 24. Price EUR 27.68 — above entry. |
...
| CTAS | Cintas | Quality but P/E ~40x, way too expensive |

---

Archived: TEP.PA SOLD (QS 46, AI disruption). FUTR.L SOLD (QS 32 Tier D). HRB SOLD (moat breach). MORN SOLD (rotated to TW+WKL.AS). DOM.L SOLD (restructuring).
