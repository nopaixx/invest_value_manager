...
## German Fiscal Stimulus (EUR 120B+ Package)

- EUR 120B federal investment in 2026 (EUR 58B from special infrastructure fund)
- EUR 33.7B for transport infrastructure
- Adds 0.3-0.5pp to GDP growth
- **Auto sector impact**: INDIRECT at best. Infrastructure spending does not directly boost car demand. May improve roads/charging infrastructure over time. Skilled labor diverted from auto to construction
- Not a catalyst for mass-market auto recovery. The problems are structural (competition, margins, EV transition), not cyclical
...
|--------|-------|----------|----------------------|
| VOW3.DE | Analyzed Feb 2026, REJECT | Baja | ROIC > WACC for 2Q, FCF+, margin >7% |
| BMW.DE | Best positioned legacy (25% BEV share) | Baja | Correction -30%+ AND ROIC > WACC |
| STLA.MI | Adopting Leapmotor tech = conceding | Muy baja | ROIC positive, FCF+ |
...
| BMW.DE | BMW | 24 | Tier D, ROIC < WACC, FCF negativo | 2026-02-05 |
...
## Condiciones para Upgrade a INFRAPONDERAR (Mass-Market Only)

1. **One OEM shows ROIC > WACC for 2+ quarters**
