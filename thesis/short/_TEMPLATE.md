...
[De que depende la valoracion actual que el mercado asume permanente? Cadena de "de que depende?" hasta dato primario verificable.]
...
## 5. Que puede salir mal (para nuestro short) — Principio 11

- [Empresa mejora fundamentalmente]
- [Short squeeze risk]
- [Catalizador se pospone]
- [Evento binario que suba 50%+ overnight]
...
- Stop loss: $[price]
- Carry estimado: ~EUR[X]/mes (~[Y]% anual)

## 8. Servicio al portfolio (Principio 12)

[Este short protege mis longs (cual?), genera cash para futuras compras, o mejora las metricas de que forma? Si no sirve al portfolio = no shortear.]

## 9. Contrathesis Framework — 4 Filtros

### Filtro 1: Que asume el precio
